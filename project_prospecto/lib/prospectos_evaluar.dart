...
class ProspectosEvaluar extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _ProspectosEvaluar();
  }
}

class _ProspectosEvaluar extends State<ProspectosEvaluar> {
  Map data;
  List usersData;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      children: [
        Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              print(index);
              if (usersData[index]["estado"].toString() == "Enviado") {
                return Card(
                    child: InkWell(
                  onTap: () {
        ...
        GradientBack("Evaluación de prospectos")
      ],
    ));
  }
}
